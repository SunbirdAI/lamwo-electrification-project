import React, { Component, PureComponent, Fragment, createRef, Children, cloneElement, useState, useMemo, useCallback, useEffect, useRef, isValidElement } from 'react';
...
class RadialAxis extends Component {
    render() {
        ...
        return (React.createElement(Fragment, null,
            ...
            ticks && (React.createElement(CloneElement, { element: ticks, scale: xScale, type: type, innerRadius: innerRadius, outerRadius: outerRadius }))));
    }
}
    ...
    render() {
        ...
        return (React.createElement(Move, { cursor: "ew-resize", onMoveStart: bind(this.onMoveStart, this), onMove: bind(this.onMove, this), onMoveEnd: bind(this.onMoveEnd, this) },
            React.createElement("g", null,
                React.createElement("line", { className: css$s.line, y1: "0", y2: height, x1: "5", x2: "5" }),
                React.createElement("rect", { className: classNames(css$s.handle, { [css$s.dragging]: isDragging }), height: height - 10, style: { cursor: 'ew-resize' }, width: 8, y: "5", y1: height - 5 }),
                React.createElement("g", { transform: `translate(-1, ${height / 2 - 10})`, style: { pointerEvents: 'none' } }, range(5).map((i) => (React.createElement("circle", { cy: i * 5, cx: "5", r: ".5", key: i, className: css$s.dot })))))));
    }
}
...
class BrushSlice extends PureComponent {
    ...
    render() {
        ...
        const hasNoSlice = start === 0 && end === width;
        return (React.createElement(Fragment, null,
            React.createElement("rect", { className: css$r.unsliced, height: height, width: start }),
            React.createElement("rect", { transform: `translate(${end}, 0)`, className: css$r.unsliced, height: height, width: endSliceWidth }),
            React.createElement("g", { transform: `translate(${start}, 0)` },
                React.createElement(Move, { cursor: "grabbing", onMoveStart: bind(this.onMoveStart, this), onMove: bind(this.onMove, this), onMoveEnd: bind(this.onMoveEnd, this) },
                    React.createElement("rect", { className: css$r.slice, height: height, width: sliceWidth, style: {
...
const ChartContainer = (_a) => {
    ...
    return (React.createElement("div", { ref: ref, style: { height: styleHeight, width: styleWidth } }, height > 0 && width > 0 && (React.createElement("svg", { width: width, height: height, className: className, style: style },
...
class DiscreteLegend extends Component {
    render() {
        ...
        const className = classNames(css$q.container, this.props.className, {
...
class DiscreteLegendSymbol extends PureComponent {
    render() {
        ...
        return (React.createElement("div", { className: classNames(css$p.symbol, className), style: { background: color } }));
    }
}
...
class DiscreteLegendEntry extends Component {
    render() {
        ...
        const className = classNames(css$o.entry, this.props.className, {
        ...
        return (React.createElement("div", { title: title, className: className, onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, style: style },
            ...
            React.createElement("span", { className: css$o.label }, label)));
    }
}
...
class SequentialLegend extends PureComponent {
    render() {
        ...
        return (React.createElement("div", { style: style, className: classNames(css$n.container, className, {
                [css$n.vertical]: orientation === 'vertical',
                [css$n.horizontal]: orientation === 'horizontal'
            }) },
            React.createElement("div", { className: css$n.start }, formatValue(start)),
            React.createElement("div", { className: css$n.gradient, style: {
                    background: `linear-gradient(${gradientDir}${color})`
                } }),
            React.createElement("div", { className: css$n.end }, formatValue(end))));
    }
}
...
const Gridline = ({ strokeWidth = 1, direction = 'all', strokeColor = 'rgba(153, 153, 153, 0.5)', data, height, width, scale, strokeDasharray }) => {
    ...
    return (React.createElement("line", Object.assign({}, coords, { className: css$m.gridLine, strokeDasharray: strokeDasharray, strokeWidth: strokeWidth, stroke: strokeColor, fill: "none" })));
};
...
GridlineSeries.defaultProps = {
    line: React.createElement(Gridline, { direction: "all" }),
    stripe: null
};
...
const GridStripe = ({ fill = '#393c3e', position, data, height, width, scale, index }) => {
    ...
    return React.createElement("rect", Object.assign({ className: css$l.gridStripe }, coords));
};
...
const MarkLine = ({ pointX, height, strokeWidth = 1, strokeColor = '#eee' }) => (React.createElement("line", { stroke: strokeColor, strokeWidth: strokeWidth, y1: "0", vectorEffect: "non-scaling-stroke", y2: height, x1: pointX, x2: pointX, className: css$k.markLine }));

const GradientStop = ({ color, offset, stopOpacity = 1 }) => React.createElement("stop", { offset: offset, stopOpacity: stopOpacity, stopColor: color });
...
const Gradient = ({ id, color, direction = 'vertical', stops = [
    ...
    return (React.createElement("linearGradient", Object.assign({ spreadMethod: "pad", id: id }, pos), stops.map((stop, index) => (React.createElement(CloneElement, { element: stop, key: `gradient-${index}`, color: stop.props.color || color })))));
};
...
] }) => (React.createElement("radialGradient", { id: id, cx: 0, cy: 0, r: radius, gradientUnits: "userSpaceOnUse" }, stops.map((stop, index) => (React.createElement(CloneElement, { element: stop, key: `gradient-${index}`, color: color })))));
...
const TooltipTemplate = ({ value, color, className }) => {
    ...
    const renderValues = (data, index) => {
        ...
        return (React.createElement("span", { className: css$j.subValue },
            React.createElement("span", { className: css$j.subValueColor, style: { backgroundColor: fill } }),
            React.createElement("span", { className: css$j.subValueName },
    ...
    return (React.createElement("div", { className: className, role: "tooltip" },
        React.createElement("div", { className: css$j.label }, formatValue(value.x)),
        React.createElement("div", { className: css$j.value },
...
function wrapText({ key, x = 0, width, fontFamily, fontSize }) {
    ...
    if (size.width > width) {
        ...
        return rows.map((r, i) => (React.createElement("tspan", { key: i, dominantBaseline: "alphabetic", style: { baselineShift: '0%' }, dy: i > 0 ? size.height : -size.height / 2, x: x }, r)));
    }
    return key;
}
...
const ScatterPoint = (_a) => {
    ...
    return (React.createElement(Fragment, null,
        React.createElement("g", { ref: rectRef, onMouseEnter: () => {
            ...
            }) }, symbol ? (React.createElement(motion.g, Object.assign({ key: `symbol-${id}-${data.id}` }, extras, { initial: {
                ...
                translateY: exitProps.y,
                opacity: 0
            }, transition: transitionProps }), renderedSymbol)) : (React.createElement(motion.circle, { key: `symbol-${id}-${data.id}`, className: extras.className, style: Object.assign(Object.assign({}, extras.style), { cursor }), initial: {
                cx: exitProps.x,
                cy: exitProps.y,
                fill,
                r,
        ...
        tooltip && !tooltip.props.disabled && (React.createElement(CloneElement, { element: tooltip, visible: tooltipVisible, reference: rectRef, value: data }))));
};
...
const ScatterSeries = (_a) => {
    var { data, height, width, id, isZoomed, activeIds, point = React.createElement(ScatterPoint, null) } = _a, rest = __rest(_a, ["data", "height", "width", "id", "isZoomed", "activeIds", "point"]);
    ...
    return (React.createElement(Fragment, null,
        ...
        React.createElement("g", { clipPath: `url(#${id}-path)` }, data.map(renderPoint))));
};
...
class ScatterPlot extends Component {
    ...
    render() {
        ...
        return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$h.scatterPlot, className) }, (props) => this.renderChart(props)));
    }
}
...
class PointSeries extends Component {
    ...
    render() {
        ...
        return (React.createElement(ScatterSeries, { height: height, width: width, id: id, animated: animated, data: data, xScale: xScale, yScale: yScale, point: React.createElement(CloneElement, { element: point, color: color, className: css$g.point, size: 4, tooltip: null, visible: this.isVisible.bind(this) }) }));
    }
}
...
class AreaChart extends Component {
    ...
    render() {
        ...
        return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$f.areaChart, className, series.type) }, (props) => this.renderChart(props)));
    }
}
...
class Bar extends Component {
    ...
    renderGuideBar() {
        ...
        return (React.createElement(CloneElement, Object.assign({ element: guide }, coords, { active: active })));
    }
    render() {
...
class RangeLines extends Component {
    ...
    render() {
        ...
        delete animate.x;
        delete animate.y;
        return (React.createElement(motion.rect, { pointerEvents: "none", fill: color, width: width, height: height, initial: initial, animate: animate, exit: initial, transition: Object.assign(Object.assign({}, DEFAULT_TRANSITION), { delay }) }));
    }
}
...
StackedBarSeries.defaultProps = Object.assign(Object.assign({}, BarSeries.defaultProps), { type: 'stacked', bar: (React.createElement(Bar, { gradient: React.createElement(Gradient, { stops: [
...
StackedNormalizedBarSeries.defaultProps = Object.assign(Object.assign({}, BarSeries.defaultProps), { type: 'stackedNormalized', tooltip: (React.createElement(TooltipArea, { tooltip: React.createElement(ChartTooltip, { followCursor: true, modifiers: {
            ...
            } }) })), bar: (React.createElement(Bar, { gradient: React.createElement(Gradient, { stops: [
                React.createElement(GradientStop, { offset: "5%", stopOpacity: 0.1, key: "start" }),
                React.createElement(GradientStop, { offset: "90%", stopOpacity: 0.7, key: "stop" })
            ] }), rangeLines: React.createElement(RangeLines, { position: "top", strokeWidth: 3 }) })) });
...
MarimekkoBarSeries.defaultProps = Object.assign(Object.assign({}, BarSeries.defaultProps), { type: 'marimekko', padding: 10, tooltip: (React.createElement(TooltipArea, { tooltip: React.createElement(ChartTooltip, { followCursor: true, modifiers: {
            ...
            } }) })), bar: (React.createElement(Bar, { padding: 10, gradient: React.createElement(Gradient, { stops: [
                React.createElement(GradientStop, { offset: "5%", stopOpacity: 0.1, key: "start" }),
                React.createElement(GradientStop, { offset: "90%", stopOpacity: 0.7, key: "stop" })
            ] }), rangeLines: React.createElement(RangeLines, { position: "top", strokeWidth: 3 }) })) });
...
const GuideBar = (_a) => {
    ...
    return (React.createElement(motion.rect, Object.assign({}, other, { fill: fill, pointerEvents: "none", initial: "hidden", animate: active ? 'visible' : 'hidden', variants: {
...
class BarChart extends Component {
    ...
    render() {
        ...
        return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$e.barChart, className, css$e[series.props.type]) }, (props) => this.renderChart(props)));
    }
}
...
const HiveNode = ({ angle, radius, node, color, onClick, onMouseOver, onMouseOut, active, disabled }) => {
    ...
    return (React.createElement("circle", { className: classNames(css$d.node, {
...
const HiveAxis = ({ radius, index, angle, color }) => {
    ...
    return (React.createElement(Fragment, null,
        React.createElement("line", { className: css$c.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index))})`, x1: axisStart, x2: axisEnd }),
        React.createElement("line", { className: css$c.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: -axisLength / 20, x2: axisLength / 20, y1: -axisEnd, y2: -axisEnd }),
        React.createElement("line", { className: css$c.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: -axisStart / 3, x2: 0, y1: axisStart * -0.8, y2: axisStart * -1 }),
        React.createElement("line", { className: css$c.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: 0, x2: axisStart / 3, y1: -axisStart, y2: axisStart * -0.8 })));
};
...
const HiveLink = ({ angle, radius, link, color, active, onMouseOver, onMouseOut }) => {
    ...
    return (React.createElement("path", { className: classNames(css$b.link, {
...
const HiveLabel = ({ index, text, angle, outerRadius, label }) => {
    ...
    return (React.createElement("text", { dy: translate(transform, outerRadius, label.padding), className: css$a.label, strokeWidth: "0.01", textAnchor: "middle", transform: `rotate(${transform})` }, text));
};
...
const HiveTooltip = ({ axis, nodes, node }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: css$9.label },
            label,
            " - ",
            formatValue(node.value)),
        React.createElement("div", { className: css$9.value },
            formatValue(count),
            " Total")));
};
...
const HivePlot = ({ axis = [], nodes = [], links = [], disabled = false, activeIds = [], label = {
    ...
    const renderAxis = useCallback(({ angle, radius, axisColor, outerRadius }) => (React.createElement(Fragment, null, axis.map((a, i) => (React.createElement("g", { key: `axis-${a.attribute}` },
        React.createElement(HiveAxis, { angle: angle, index: i, color: axisColor, radius: radius }),
        label.show && (React.createElement(HiveLabel, { index: i, text: a.label, label: label, outerRadius: outerRadius, angle: angle }))))))), [axis, label]);
    ...
    const renderLinks = useCallback(({ angle, radius, domainColor }) => (React.createElement(Fragment, null, links.map((link, i) => {
        return (React.createElement(HiveLink, { key: `${link.value}-${i}`, color: link.color || domainColor, active: isActive(link, i, 'link'), angle: angle, radius: radius, link: link, onMouseOver: (event) => onLinkMouseOverLocal(link, event), onMouseOut: (event) => onLinkMouseOutLocal(link, event) }));
    }))), [links]);
    const renderNodes = useCallback(({ angle, radius, domainColor }) => (React.createElement(Fragment, null, nodes.map((node, i) => (React.createElement(HiveNode, { node: node, key: `${node.value}-${i}`, active: isActive(node, i, 'node'), color: domainColor, radius: radius, angle: angle, disabled: disabled, onMouseOver: (event) => onNodeMouseOverLocal(node, event), onMouseOut: (event) => onNodeMouseOutLocal(node, event), onClick: (event) => onNodeClickLocal(node, event) }))))), [nodes, disabled]);
    const renderTooltip = useCallback(() => {
        const { formatter, placement, show } = tooltip;
        return (React.createElement(Fragment, null, !disabled && show && (React.createElement(Tooltip, { visible: !!active, reference: tooltipReference, placement: placement, content: () => formatter(axis, nodes, linkTooltipData, nodeTooltipData) ||
                (nodeTooltipData ? (React.createElement(HiveTooltip, { node: nodeTooltipData, nodes: nodes, axis: axis })) : null) }))));
    }, [
        tooltip,
        disabled,
        axis,
    ...
    const renderChart = useCallback(({ height: containerHeight, width: containerWidth }) => {
        ...
        return (React.createElement(Fragment, null,
            React.createElement("svg", { width: containerWidth, height: containerHeight, className: classNames(className) },
                React.createElement("g", { transform: `translate(${containerWidth / 2}, ${containerHeight / 2 + innerRadius})` },
                    renderAxis(data),
                    renderLinks(data),
                    renderNodes(data))),
            renderTooltip()));
    }, [innerRadius, axis, colorScheme, label, className]);
    return (React.createElement(ChartContainer, { height: height, width: width }, renderChart));
};
...
const Map$1 = ({ id, width, height, margins, className, markers, data, fill = 'rgba(255, 255, 255, 0.3)' }) => {
    ...
    const renderCountry = useCallback((point, index, path) => {
        ...
        return React.createElement("path", { key: `path-${index}`, d: path(point), fill: fill });
    }, [fill]);
    const renderChart = useCallback((containerProps) => {
        ...
        return (React.createElement(motion.g, { initial: {
            ...
            markers &&
                markers.map((marker, index) => (React.createElement(Fragment, { key: `marker-${index}` }, renderMarker(marker, index, projection))))));
    }, [data, markers]);
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, className: className }, (props) => renderChart(props)));
};
...
const MapMarker = ({ size = 3, index, tooltip, cx, cy, onClick = () => undefined }) => {
    ...
    return (React.createElement(Fragment, null,
        ...
        tooltip && (React.createElement(Tooltip, { visible: active, reference: ref, modifiers: modifiers$1, content: tooltip }))));
};
...
const PieArc = ({ color, data, arc, cursor = 'initial', animated = true, disabled = false, onClick = () => undefined, onMouseEnter = () => undefined, onMouseLeave = () => undefined, tooltip = React.createElement(ChartTooltip, null) }) => {
    ...
    return (React.createElement("g", { ref: arcRef },
        React.createElement(motion.path, { role: "graphics-symbol", transition: transition, d: d, style: { cursor }, fill: fill, onMouseEnter: (event) => {
                if (!disabled) {
                    setActive(true);
                    onMouseEnter({
                        value: data.data,
        ...
        tooltip && !tooltip.props.disabled && (React.createElement(CloneElement, { element: tooltip, visible: !!active, reference: arcRef, value: { y: data.data.data, x: data.data.key } }))));
};
...
class PieArcLabel extends PureComponent {
    render() {
        ...
        return (React.createElement(motion.g, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: {
            ...
            typeof text === 'string' ? (React.createElement(React.Fragment, null,
                React.createElement("title", null, text),
                React.createElement("text", { dy: padding, fill: fontFill, fontSize: fontSize, fontFamily: fontFamily, textAnchor: textAnchor, style: {
                    ...
                    } }, text))) : (React.createElement("foreignObject", { width: width, height: height, style: {
                    transform: `translate3d(${textAnchor === 'start' ? posX : posX - width}px,${posY - height / 2}px, 0)`,
                    color: fontFill,
                    fontFamily,
                    fontSize
                } }, text)),
            React.createElement("polyline", { fill: "none", stroke: lineStroke, points: `${startPoint},${innerPoint},${breakPoint},${position}` })));
    }
}
...
class PieArcSeries extends Component {
    constructor() {
         ...
         */
        this.calculateLabelPositions = memoize((data, outerRadius, minDistance, cornerRadius, padAngle, padRadius) => {
    ...
    render() {
        ...
        return (React.createElement(Fragment, null, data.map((arcData, index) => (React.createElement(Fragment, { key: arcData.data.key.toString() },
            positions[index] && (React.createElement(CloneElement, { element: label, data: arcData, centroid: centroid, outerRadius: outerRadius, width: labelWidth, position: positions[index] })),
            React.createElement(CloneElement, { element: arc, data: arcData, animated: animated, arc: innerArc, color: getColor({
...
const PieChart = ({ id, width, height, className, displayAllLabels = false, data = [], margins = 10, series = React.createElement(PieArcSeries, null) }) => {
    ...
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, center: true, className: classNames(className) }, ({ chartWidth, chartHeight }) => (React.createElement(CloneElement, { element: series, data: getData, height: chartHeight, width: chartWidth, displayAllLabels: displayAllLabels }))));
};
...
class SankeyLabel extends Component {
    render() {
        ...
        return (visible &&
            node && (React.createElement("text", { className: classNames(css$7.label, className), x: showRightSide ? nodePositions.x1 + 6 : nodePositions.x0 - 6, y: (nodePositions.y1 + nodePositions.y0) / 2, dy: "0.35em", textAnchor: textAnchor, fill: fill, opacity: opacity(active), style: { padding } }, node.title)));
    }
}
...
class SankeyLink extends Component {
    ...
    renderLink() {
        ...
        return (React.createElement("g", { ref: this.link },
            React.createElement(motion.path, { key: `sankey-link-${enterProps.d}-${index}`, className: classNames(css$6.link, className), style: style, initial: exitProps, animate: enterProps, exit: exitProps, transition: {
                    duration: 0.5
    ...
    renderTooltipContent() {
        ...
        return (React.createElement("div", { className: css$6.tooltip },
            React.createElement("div", { className: css$6.tooltipLabel }, `${source.title} → ${target.title}`),
            React.createElement("div", { className: css$6.tooltipValue }, formatValue(value))));
    }
    render() {
...
class SankeyNode extends Component {
    ...
    renderNode() {
        ...
        return (React.createElement(motion.g, { ref: this.rect },
            React.createElement(motion.rect, { key: `sankey-node-${x0}-${x1}-${y0}-${y1}-${index}`, className: classNames(css$5.node, className), fillOpacity: opacity(active, disabled), style: style, width: nodeWidth, height: nodeHeight, fill: color, initial: {
                    opacity: 0,
                    attrX: x0,
                    attrY: y0
                }, animate: {
    ...
    renderTooltipContent() {
        ...
        return (React.createElement("div", { className: css$5.tooltip },
            React.createElement("div", { className: css$5.tooltipLabel }, title),
            React.createElement("div", { className: css$5.tooltipValue }, formatValue(value))));
    }
    render() {
...
const SonarChart = (props) => (React.createElement(StackedBarChart, Object.assign({}, props, { margins: 0, gridlines: null, series: React.createElement(StackedBarSeries, { type: "stackedDiverging", colorScheme: "rgb(17, 207, 247)", tooltip: React.createElement(TooltipArea, { tooltip: React.createElement(ChartTooltip, { followCursor: true, modifiers: {
            ...
            React.createElement(Bar, { key: "first", width: 1, rangeLines: null, minHeight: 1, gradient: React.createElement(Gradient, { stops: [
            ...
            React.createElement(Bar, { key: "second", width: 1, rangeLines: null, minHeight: 1, gradient: React.createElement(Gradient, { stops: [
...
const RadialArea = ({ id, data, className, yScale, color, animated, outerRadius, xScale, innerRadius, interpolation, gradient = React.createElement(RadialGradient, null) }) => {
    const transition = useMemo(() => animated
        ? Object.assign({}, DEFAULT_TRANSITION) : {
        type: false,
        delay: 0
    ...
    return (React.createElement(Fragment, null,
        React.createElement(MotionPath, { custom: {
                enter,
                exit
...
const RadialPointSeries = ({ data, xScale, yScale, animated, color, activeValues, show = 'hover', point = React.createElement(RadialScatterPoint, null) }) => {
    ...
    return (React.createElement(RadialScatterSeries, { animated: animated, data: data, xScale: xScale, yScale: yScale, point: React.createElement(CloneElement, { element: point, color: color, tooltip: null, visible: isVisible }) }));
};
...
const RadialAreaChart = ({ id, width, height, className, data, innerRadius = 0.1, series = React.createElement(RadialAreaSeries, null), axis = React.createElement(RadialAxis, null), margins = 75 }) => {
    ...
    const renderChart = useCallback((containerProps) => {
        ...
        return (React.createElement(Fragment, null,
            axis && (React.createElement(CloneElement, { element: axis, xScale: xScale, height: chartHeight, width: chartWidth, innerRadius: innerRadius })),
            React.createElement(CloneElement, { element: series, id: id, data: result, xScale: xScale, yScale: yScale, height: chartHeight, width: chartWidth, outerRadius: outerRadius, innerRadius: innerRadius })));
    }, [data, series, id, innerRadius, axis]);
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, center: true, className: className }, renderChart));
};
...
const RadialGaugeArc = ({ data, startAngle, endAngle, innerRadius, outerRadius, cornerRadius = 0, padAngle = 0, padRadius = 0, color = '#353d44', animated = true, disabled = false, onClick = () => undefined, onMouseEnter = () => undefined, onMouseLeave = () => undefined, tooltip = React.createElement(ChartTooltip, null) }) => {
    /**
    ...
    return (React.createElement(PieArc, { arc: arcGenerator, data: arcData, animated: animated, color: color, disabled: disabled, tooltip: tooltip, onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }));
};
...
class RadialGaugeLabel extends PureComponent {
    render() {
        ...
        return (React.createElement("text", { x: "0", y: offset, textAnchor: "middle", 
            // This is only valid when placed below the chart
            alignmentBaseline: 'text-after-edge', onClick: (nativeEvent) => onClick({ data, nativeEvent }), className: classNames(className, css$3.valueLabel) }, label));
    }
}
...
class RadialGaugeValueLabel extends PureComponent {
    render() {
        ...
        return (React.createElement(CountUp, { start: 0, end: data.data, delay: 0, duration: 1, separator: "," }, ({ countUpRef }) => (React.createElement("text", { dy: "-0.5em", x: "0", y: "15", textAnchor: "middle", className: classNames(className, css$2.valueLabel), ref: countUpRef }))));
    }
}
RadialGaugeValueLabel.defaultProps = {};

const RadialGaugeSeries = (_a) => {
    var { data, scale, startAngle, endAngle, arcWidth = 10, outerArc = React.createElement(RadialGaugeArc, { disabled: true }), innerArc = React.createElement(RadialGaugeArc, { animated: true }), label = React.createElement(RadialGaugeLabel, null), valueLabel = React.createElement(RadialGaugeValueLabel, null), colorScheme = ['#00ECB1'], padding = 20, minGaugeWidth = 50 } = _a, props = __rest(_a, ["data", "scale", "startAngle", "endAngle", "arcWidth", "outerArc", "innerArc", "label", "valueLabel", "colorScheme", "padding", "minGaugeWidth"]);
    function getWidths() {
        let rows = 1;
    ...
    return (React.createElement(React.Fragment, null, data.map((d, i) => renderGauge(d, i, columns, height, width, xScale, yScale))));
};
...
const StackedRadialGaugeLabel = ({ label, className, yOffset = 0 }) => (React.createElement(React.Fragment, null, label && (React.createElement("text", { x: "0", y: yOffset, textAnchor: "middle", alignmentBaseline: "middle", className: classNames(className, css$1.stackedValueLabel) }, label))));

const StackedRadialGaugeSeries = ({ data, width, height, scale, startAngle, endAngle, outerArc = React.createElement(RadialGaugeArc, { disabled: true }), innerArc = React.createElement(RadialGaugeArc, { animated: true }), label = React.createElement(StackedRadialGaugeLabel, null), colorScheme = ['#00ECB1'], fillFactor = 0.2, arcPadding = 0.15 }) => {
    ...
    function renderStackedGauges(point, index, rAxis) {
        ...
        return (React.createElement("g", { key: point.key.toLocaleString() },
            outerArc &&
                cloneElement(outerArc, {
                    outerRadius,
                    innerRadius,
...
const RadialGauge = ({ id, width, height, margins, className, data, minValue = 0, maxValue = 100, startAngle = 0, endAngle = Math.PI * 2, series = React.createElement(RadialGaugeSeries, null) }) => {
    const scale = scaleLinear()
        .domain([minValue, maxValue])
        .range([startAngle, endAngle]);
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, className: className }, (props) => cloneElement(series, {
        scale,
        data,
        startAngle,
        endAngle,
...
const HeatmapCell = (_a) => {
    var { rx = 2, ry = 2, cursor = 'auto', tooltip = React.createElement(ChartTooltip, null), onClick = () => undefined, onMouseEnter = () => undefined, onMouseLeave = () => undefined, data, animated, cellIndex, cellCount, fill, x, y, style, className } = _a, rest = __rest(_a, ["rx", "ry", "cursor", "tooltip", "onClick", "onMouseEnter", "onMouseLeave", "data", "animated", "cellIndex", "cellCount", "fill", "x", "y", "style", "className"]);
    const [active, setActive] = useState(false);
    ...
    return (React.createElement(Fragment, null,
        React.createElement("g", { ref: rect },
            React.createElement(motion.rect, Object.assign({}, rest, { fill: fill, stroke: stroke, x: x, y: y, style: Object.assign(Object.assign({}, extras.style), { cursor }), className: classNames(css.cell, extras.className), initial: {
                    opacity: 0
                }, animate: {
                    opacity: 1
                }, exit: {
        ...
        tooltip && !tooltip.props.disabled && !isTransparent && (React.createElement(CloneElement, { element: tooltip, visible: active, modifiers: tooltip.props.modifiers || modifiers, reference: rect, value: tooltipData }))));
};
...
const Heatmap = ({ data = [], margins = 10, series = React.createElement(HeatmapSeries, null), yAxis = (React.createElement(LinearYAxis, { type: "category", axisLine: null, tickSeries: React.createElement(LinearYAxisTickSeries, { line: null, label: React.createElement(LinearYAxisTickLabel, { padding: 5 }) }) })), xAxis = (React.createElement(LinearXAxis, { type: "category", axisLine: null, tickSeries: React.createElement(LinearXAxisTickSeries, { line: null, label: React.createElement(LinearXAxisTickLabel, { padding: 5 }) }) })), secondaryAxis, id, width, height, className }) => {
    ...
    const renderChart = (containerProps) => {
        ...
        return (React.createElement(Fragment, null,
            React.createElement(CloneElement, { element: xAxis, height: chartHeight, width: chartWidth, scale: xScale, onDimensionsChange: (event) => updateAxes('horizontal', event) }),
            React.createElement(CloneElement, { element: yAxis, height: chartHeight, width: chartWidth, scale: yScale, onDimensionsChange: (event) => updateAxes('vertical', event) }),
            secondaryAxis &&
                secondaryAxis.map((axis, i) => (React.createElement(CloneElement, { key: i, element: axis, height: chartHeight, width: chartWidth, onDimensionsChange: (event) => updateAxes('horizontal', event) }))),
            React.createElement(CloneElement, { element: series, id: `heat-series-${id}`, data: scalesData, xScale: xScale, yScale: yScale })));
    };
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: className }, renderChart));
};
...
const CalendarHeatmap = (_a) => {
    var { view = 'year', series = (React.createElement(HeatmapSeries, { padding: 0.3, emptyColor: 'transparent', cell: React.createElement(HeatmapCell, { tooltip: React.createElement(ChartTooltip, { content: (d) => `${formatValue(d.data.metadata.date)} ∙ ${formatValue(d.data.value)}` }) }) })), data } = _a, rest = __rest(_a, ["view", "series", "data"]);
...
const VennArc = ({ data, fill, disabled, animated, stroke, mask, id, active = false, style, inactiveStyle = { opacity: 0.3 }, activeStyle = { opacity: 0.8 }, initialStyle = { opacity: 0.6 }, strokeWidth = 3, gradient = React.createElement(Gradient, null), tooltip = React.createElement(ChartTooltip, null), onClick = () => undefined, onMouseEnter = () => undefined, onMouseLeave = () => undefined }) => {
    ...
    const arcFill = gradient && !mask
        ...
        : mask
            ? `url(#mask-pattern-${id})`
            : fill;
    return (React.createElement("g", { title: data.data.key, onMouseEnter: (event) => {
            if (!disabled) {
        ...
        React.createElement(motion.path, { ref: arcRef, fill: arcFill, id: `${id}-arc`, strokeWidth: strokeWidth, stroke: stroke, transition: transition, d: d, initial: initialStyle, animate: currentStyle, style: style }),
        mask && (React.createElement(Fragment, null,
            React.createElement(Mask, { id: `mask-${id}`, fill: `url(#gradient-${id})` }),
            React.createElement(CloneElement, { element: mask, id: `mask-pattern-${id}`, fill: fill }))),
        gradient && (React.createElement(CloneElement, { element: gradient, id: `gradient-${id}`, color: fill })),
        tooltip && !tooltip.props.disabled && (React.createElement(CloneElement, { element: tooltip, visible: !!internalActive, reference: arcRef, value: { y: data.data.size, x: (_b = (_a = data.data) === null || _a === void 0 ? void 0 : _a.sets) === null || _b === void 0 ? void 0 : _b.join(' | ') } }))));
};
...
const VennLabel = ({ data, format, id, active, labelType = 'key', showAll = false, wrap = true, animated = true, fill = '#000', fontSize = 11, fontFamily = 'sans-serif' }) => {
    ...
    const text = wrap
        ...
        : key;
    return (React.createElement(motion.text, { id: `${id}-text`, style: { pointerEvents: 'none', fontFamily, fontSize }, fill: fill, initial: {
            attrX: data.text.x,
            attrY: data.text.y,
            opacity: 1
        }, animate: {
...
const VennOuterLabel = ({ data, format, animated = true, fill = '#000', fontSize = 14, fontFamily = 'sans-serif' }) => {
    ...
    return (React.createElement(Fragment, null, isElement ? (React.createElement("g", { style: { transform: `translate(${pos.x}px, ${pos.y}px)` } }, label)) : (React.createElement(motion.text, { fill: fill, style: { pointerEvents: 'none', fontFamily, fontSize }, textAnchor: data.set.align === 'middle' ? 'center' : data.set.align, alignmentBaseline: data.set.verticalAlign, initial: {
            attrX: pos.x,
            attrY: pos.y
        }, animate: {
            attrX: pos.x,
...
const VennSeries = ({ data, id, selections, animated = true, disabled = false, colorScheme = 'cybertron', outerLabel = React.createElement(VennOuterLabel, null), arc = React.createElement(VennArc, null), label = React.createElement(VennLabel, null) }) => {
    ...
    const renderArc = useCallback((d, index) => {
        ...
        const arcStroke = stroke ||
            chroma(arcFill)
                ...
                .hex();
        return (React.createElement(Fragment, { key: safeKey },
            React.createElement(CloneElement, { element: arc, id: `${id}-${safeKey}`, data: d, fill: arcFill, stroke: arcStroke, disabled: disabled, animated: animated, active: isActive, onMouseEnter: () => onActivate(key), onMouseLeave: () => {
                    setActives([]);
                    setHovered(null);
                } }),
            React.createElement(CloneElement, { element: label, data: d, id: `${id}-${safeKey}`, active: isActive, animated: animated }),
            d.set && outerLabel && (React.createElement(CloneElement, { element: outerLabel, data: d, animated: animated }))));
    }, [
        colorScheme,
        data,
        arc,
    ...
    return (React.createElement(motion.g, { initial: { opacity: 0, scale: 0 }, animate: { opacity: 1, scale: 1 }, transition: transition },
        data.map(renderArc),
        topArcs.length > 0 &&
            topArcs.map((a) => (React.createElement("use", { key: a, xlinkHref: `#${id}-${a}-arc`, style: { pointerEvents: 'none' } }))),
        data.map((d, index) => (React.createElement("use", { key: index, xlinkHref: `#${id}-${getSafeKey(d)}-text`, style: { pointerEvents: 'none' } })))));
};
...
const VennDiagram = ({ id, type = 'venn', width, height, margins, className, data, disabled, series = React.createElement(VennSeries, null) }) => {
    const renderChart = useCallback((containerProps) => {
        ...
        return (React.createElement(CloneElement, { element: series, data: layoutData, disabled: disabled, id: containerProps.id }));
    }, [data, series, type]);
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, center: false, className: className }, renderChart));
};

const Bubble = ({ id, data, fill, mask, gradient, onClick, onMouseEnter, onMouseLeave, tooltip = React.createElement(ChartTooltip, null) }) => {
    const [internalActive, setInternalActive] = useState(false);
    ...
    const arcFill = gradient && !mask
        ...
        : mask
            ...
            : fill;
    return (React.createElement(Fragment, null,
        React.createElement(motion.circle, { id: `${id}-bubble`, ref: bubbleRef, fill: arcFill, initial: {
                r: data.r,
                cx: data.x,
                cy: data.y
            }, animate: {
        ...
        mask && (React.createElement(Fragment, null,
            ...
            React.createElement(CloneElement, { element: mask, id: `mask-pattern-${id}`, fill: fill }))),
        gradient && (React.createElement(CloneElement, { element: gradient, id: `gradient-${id}`, color: fill })),
        tooltip && !tooltip.props.disabled && (React.createElement(CloneElement, { element: tooltip, visible: !!internalActive, reference: bubbleRef, value: { y: data.data.data, x: data.data.key } }))));
};
...
const BubbleLabel = ({ id, data, wrap = true, fill = '#000', fontSize = 14, fontFamily = 'sans-serif' }) => {
    ...
    return (React.createElement(motion.text, { initial: {
            x: data.x,
            y: data.y
        }, animate: {
            x: data.x,
...
const BubbleSeries = ({ id, data, colorScheme = 'cybertron', animated = true, bubble = React.createElement(Bubble, null), label = React.createElement(BubbleLabel, null) }) => {
    const transition = animated ? {} : { type: false, delay: 0 };
    const renderBubble = (item, index) => {
        ...
        return (React.createElement(motion.g, { key: item.data.key, initial: {
                scale: .5,
                opacity: 0
            }, animate: {
                scale: 1,
            ...
            React.createElement(CloneElement, { element: bubble, id: `${id}-bubble`, animated: animated, data: item, fill: fill }),
            React.createElement(CloneElement, { element: label, id: `${id}-label`, animated: animated, data: item })));
    };
    return (React.createElement(Fragment, null, data.map(renderBubble)));
};

const BubbleChart = ({ data = [], id, width, height, className, margins = 10, series = React.createElement(BubbleSeries, null) }) => {
    ...
    const renderChart = useCallback((_a) => {
        ...
        return (React.createElement(CloneElement, { element: series, id: `${rest.id}-series`, data: circles }));
    }, [series, getData, id]);
    return (React.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, className: className }, renderChart));
};

export { Area, AreaChart, AreaSeries, AreaSparklineChart, Bar, BarChart, BarLabel, BarSeries, BarSparklineChart, Brush, BrushSlice, Bubble, BubbleChart, BubbleLabel, BubbleSeries, CalendarHeatmap, ChartBrush, ChartContainer, ChartTooltip, ChartZoomPan, DEFAULT_TRANSITION, DiscreteLegend, DiscreteLegendEntry, DiscreteLegendSymbol, Gradient, GradientStop, GridStripe, Gridline, GridlineSeries, GuideBar, Heatmap, HeatmapCell, HeatmapSeries, HistogramBarChart, HistogramBarSeries, HivePlot, Line, LineChart, LineSeries, LinearAxis, LinearAxisLine, LinearAxisTickLabel, LinearAxisTickLine, LinearAxisTickSeries, LinearGauge, LinearGaugeBar, LinearGaugeOuterBar, LinearGaugeSeries, LinearXAxis, LinearXAxisTickLabel, LinearXAxisTickLine, LinearXAxisTickSeries, LinearYAxis, LinearYAxisTickLabel, LinearYAxisTickLine, LinearYAxisTickSeries, Map$1 as Map, MapMarker, MarimekkoBarSeries, MarimekkoChart, MarkLine, Mask, MotionPath, Move, Pan, PieArc, PieArcLabel, PieArcSeries, PieChart, PointSeries, RadialArea, RadialAreaChart, RadialAreaSeries, RadialAxis, RadialAxisArc, RadialAxisArcSeries, RadialAxisTick, RadialAxisTickLabel, RadialAxisTickLine, RadialAxisTickSeries, RadialBar, RadialBarChart, RadialBarSeries, RadialGauge, RadialGaugeArc, RadialGaugeLabel, RadialGaugeSeries, RadialGaugeValueLabel, RadialGradient, RadialGuideBar, RadialLine, RadialPointSeries, RadialScatterPlot, RadialScatterPoint, RadialScatterSeries, RangeLines, Sankey, SankeyLabel, SankeyLink, SankeyNode, ScatterPlot, ScatterPoint, ScatterSeries, SequentialLegend, SonarChart, SparklineChart, StackedAreaChart, StackedAreaSeries, StackedBarChart, StackedBarSeries, StackedNormalizedAreaChart, StackedNormalizedAreaSeries, StackedNormalizedBarChart, StackedNormalizedBarSeries, StackedRadialGaugeLabel, StackedRadialGaugeSeries, Stripes, TooltipArea, TooltipTemplate, VennArc, VennDiagram, VennLabel, VennOuterLabel, VennSeries, Zoom, ZoomPan, addWeeksToDate, bigIntegerToLocaleString, buildBarStackData, buildBins, buildDataScales, buildMarimekkoData, buildNestedChartData, buildShallowChartData, buildStackData, buildWaterfall, calculateDimensions, calculateShowStroke, constrainMatrix, constructFunctionProps, extent, formatValue, functionProps, getClosestPoint, getColor, getDegrees, getDimension, getDurationTicks, getLimitMatrix, getMaxBigIntegerForNested, getMaxBigIntegerForShallow, getMaxTicks, getParentSVG, getPointFromMatrix, getPositionForTarget, getTicks, getXDomain, getYDomain, humanFormatBigInteger, interpolate, isAxisVisible, isZoomLevelGoingOutOfBounds, normalizeValue, normalizeValueForFormatting, reduceTicks, schemes, toggleTextSelection, uniqueBy, weekDays, wrapText };
